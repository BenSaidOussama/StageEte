...
<body>
    ...
    <table>
        <tr>
          ...
          {!!Form::open(['action' => ['TemplateController@EditTemplate',$template->id], 'method' => 'PUT', 'class' => 'pull-right'])!!}       

                  <button style='width:120%' type="submit" class="btn btn-info"><i class="fa fa-edit " ></i>   Edit</button>
