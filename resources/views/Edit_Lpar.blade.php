                            ...
                            <div class='panel' >  
                                ...
                                <table id="table_shared" style='margin-left:50px;display: block;' >
                                    <tr>
                                        ...
                                        <td>
                                        <input type='number' value="{{$lpar->min_proc_units}}" placeholder="0.1" step="0.1" class ='form-control' name='min_proc_units' id="id_min_proc_units">
                                        </td>
                                        <td style='text-align:right'>
                                             Minimum virtual processors *
                                        </td>
                                        <td>
                                            <input type='number' value="{{$lpar->min_v_proc}}" step="0.1" placeholder="0.1" class ='form-control' name='min_v_proc' id="id_min_v_proc">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td >
                                        ...
                                        <td>
                                        <br>
                                            <input type='number' value="{{$lpar->disired_proc_units}}"  step="0.1" placeholder="0.1" name='desired_proc_units' class ='form-control' id="id_desired_proc_units">
                                        </td>
                                        <td style='text-align:right' >
                                        <br>
                                            ...
                                            <td>
                                            <br>
                                                <input type='number' step="0.1" value="{{$lpar->disired_v_proc}}" placeholder="0.1" name='desired_v_proc' class ='form-control' id="id_desired_v_proc">
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <br>
                                                ...
                                                <input type='number' step="0.1" value="{{$lpar->max_proc_units}}" placeholder="0.1" name='max_proc_units' class ='form-control' id="id_max_proc_units">
                                            </td>
                                            ...
                                            <td>
                                            <br>
                                                <input type='number' step="0.1" value="{{$lpar->max_v_proc}}" placeholder="0.1" name='max_v_proc' class ='form-control' id="id_max_v_proc">
                                            </td>
                                    ...
                                    <input type="text" id="shared_1" value="{{$lpar->shared}}" hidden>
                                       ...
                                       <p id="p_dedicated" style="display: none"> <B>    Specify the desired, minimum, and maximum processing settings in the fields below.</B></p>
                                          <table id="table_dedicated" style='margin-left:50px;display: none;' >
                                                      <tr>
                                                          ...
                                                          <input type='number' value='{{$lpar->min_proc}}' placeholder="1" class ='form-control' name='min_proc' id="id_min_proc">
                                                          </td>
                                                      </tr>
                                                      <tr>
                                                          <td>
                                                          ...
                                                          <td>
                                                          <br>
                                                          <input type='number' value='{{$lpar->desired_proc}}' placeholder="1" class ='form-control' name='desired_proc' id="id_desired_proc">
                                                          </td>
                                                      </tr>
                                                      <tr>
                                                          <td>
                                                          ...
                                                          <td>
                                                          <br>
                                                          <input type='number' placeholder="1" value='{{$lpar->max_proc}}' class ='form-control' name='max_proc' id="id_max_proc">
                                                          </td>
                                                     </tr>
                                              </table>
                                            <br>
                            ...
                            <div class="panel">
                                <table >
                                    <tr>
                                        ...
                                        <td >
                                             <input  class ="form-control" value="{{$lpar->min_memory}}" type="range" min="0" max="100" step="0.1" value="0" class="slider" id="myRange">
                                        </td> 
                                        <td style="text-align:right">
                                    ...
                                    <tr>
                                        ...
                                        <td >
                                             <input class ="form-control"  value="{{$lpar->disired_memory}}" type="range" min="0" max="100" step="0.1" value="0" class="slider1" id="myRange1">
                                        </td> 
                                        <td style="text-align:right">
                                    ...
                                    <tr>
                                        ...
                                        <td >
                                             <input class ="form-control"  type="range" name="max_memo"  value="{{$lpar->max_memory}}"  step="0.1" min="0" max="100" value="0" class="slider2" id="myRange2">
                                        </td> 
                                        <td style="text-align:right">
...
input_max_v_adapters.oninput = function() {
          ...
          if(input_max_v_adapters.value<=input_max_v_adapters_hidden3.value){
            document.getElementById("btn_ethernet").disabled=true;
            document.getElementById("btn_fc").disabled=true;
            document.getElementById("btn_scsi").disabled=true;  
          }
